...
class _TakePhotoPageState extends State<TakePhotoPage> {
  ...
  void displayBottomSheet(BuildContext context) {
    print("print " + ((MediaQuery.of(context).size.height) * 0.16).toString());
              ...
              child: Container(
                ...
                children: <Widget>[
                  ListTile(
                      ...
                      onTap: () {
                        onIdentificationCardButtonPressed();
                      }),
                  ListTile(
                      leading: Icon(Icons.directions_car),
                      title: Text('Driver License'),
                      onTap: () {
                        onDriverLicenseButtonPressed();
                      }),
                  ListTile(
                      leading: Icon(Icons.book),
                      title: Text('Passport'),
                      onTap: () {
                        onPassportButtonPressed();
                      }),
                ],
              )));
        });
  ...
  ChewieController getChewieController() {
    ...
    chewieController = ChewieController(
        ...
        videoPlayerController:
            VideoPlayerController.file(File(registerStorage.videoPath)),
